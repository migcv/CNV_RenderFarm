...
public class StatisticsTool {
	...
	public static void doStatic(File in_dir) throws IOException {
		...
		aux.append("Static information summary: \n" + "Number of class files:  " + class_count + "\n"
				+ "Number of methods:      " + method_count + "\n" + "Number of basic blocks: " + bb_count + "\n"
				+ "Number of instructions: " + instr_count + "\n");
		FileWriter log = new FileWriter("log/STATISTICTOOL_thread" + Thread.currentThread().getId() + ".txt");
		...
		aux.append("Average number of instructions per basic block: " + instr_per_bb + "\n"
				+ "Average number of instructions per method:      " + instr_per_method + "\n"
				+ "Average number of instructions per class:       " + instr_per_class + "\n"
				+ "Average number of basic blocks per method:      " + bb_per_method + "\n"
				+ "Average number of basic blocks per class:       " + bb_per_class + "\n"
				+ "Average number of methods per class:            " + method_per_class + "\n");
	...
	public static synchronized void printDynamic(String foo) throws IOException {

		aux.append("Dynamic information summary: \n" + "Number of methods:      " + dyn_method_count + "\n"
	...
	public static synchronized void printAlloc(String s) throws IOException {
		...
		aux.append("Allocations summary:\n" + "new:            " + newcount + "\n" + "newarray:       " + newarraycount
	...
	public static synchronized void printLoadStore(String s) throws IOException {
		aux.append("Load Store Summary:\n" + "Field load:    " + fieldloadcount + "\n" + "Field store:   "
	...
	public static synchronized void printBranch(String foo) throws IOException {

		aux.append("Branch summary:\n" + "CLASS NAME" + '\t' + "METHOD" + '\t' + "PC" + '\t' + "TAKEN" + '\t'
				+ "NOT_TAKEN \n");
		FileWriter log = new FileWriter("log/STATISTICTOOL_thread" + Thread.currentThread().getId() + ".txt");
		log.write(aux.toString());
		log.close();
	...
	public static void main(String argv[]) throws IOException {
		...
		aux.append("----- StatisticsTool // " + argv[0] + " -----");
