...
public class LoadBalancer {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			runInstancesRequest.withImageId("ami-d8ba22b8").withInstanceType("t2.micro").withMinCount(1).withMaxCount(1)
					.withKeyName("CNV-lab-AWS").withSecurityGroups("CNV-ssh+http");
