...
public class Dynamo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            // Add an item
            Map<String, AttributeValue> item = newItem("text04.txt", 400, 300, 400, 300, 0,0);
            PutItemRequest putItemRequest = new PutItemRequest(tableName, item);
            PutItemResult putItemResult = dynamoDB.putItem(putItemRequest);
            System.out.println("Result: " + putItemResult);

            // Add another item
            item = newItem("text04.txt", 900, 600, 200, 200, 0,0);
            ...
            Condition condition = new Condition()
                ...
                .withAttributeValueList(new AttributeValue().withN("400"));
    ...
    private static Map<String, AttributeValue> newItem(String filename, int scols, int srows, int wcols, int wrows, int coff, int roff) {
